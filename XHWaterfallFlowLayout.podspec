...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of XHWaterfallFlowLayout.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/XHWaterfallFlowLayout'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'echo' => 'leitianshi2009@163.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/XHWaterfallFlowLayout.git', :tag => s.version.to_s }
